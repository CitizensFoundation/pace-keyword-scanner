...
const query1 = require('../scripts/queries').query1;
const query2 = require('../scripts/queries').query2;
const query3 = require('../scripts/queries').query3;
const query4 = require('../scripts/queries').query4;
const query5 = require('../scripts/queries').query5;
